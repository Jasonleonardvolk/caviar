...
Ensures replay ≡ live after every CI run
"""
...
def run_golden_test():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print("\n🎯 Step 2: Running Penrose projection...")
        ...
        print(f"  ✅ Logged ingestion event: {event_id}")
        print(f"  📊 Penrose stats: {stats['n_edges']} edges, {stats['speedup_vs_full']:.1f}x speedup")
        
        # Step 3: Create a response event
        print("\n💬 Step 3: Logging response generation...")
        ...
        print(f"  ✅ Logged response event: {response_id}")
        ...
        print(f"\n📁 Live mesh hash: {live_hash[:16]}...")
        
        # Step 4: Replay from archive
        print("\n🔄 Step 4: Replaying from archive...")
        ...
        if live_hash == replay_hash:
            ...
            print("\n❌ FAILURE: Replay ≠ Live! Archive replay differs.")
