#!/usr/bin/env python
"""
Demo of the ELFIN Unit Annotation System

This script demonstrates how to use the ELFIN Unit Annotation System to:
1. Check dimensional consistency in an ELFIN file
2. Generate Rust code with dimensional safety
"""
...
def main():
    ...
    print("ELFIN Unit Annotation System Demo")
    print("=================================")
