...
print("🔧 Fixing concept_mesh module import")
print("=" * 40)
    ...
    def load_data(self):
        ...
        if self.data_file.exists():
            try:
                ...
                print(f"✅ Concept Mesh loaded {len(self.concepts)} concepts")
            except Exception as e:
                print(f"⚠️ Error loading concept mesh: {e}")
                self.concepts = []
        else:
            print("⚠️ No concept mesh data file found")
            self.concepts = []
...
'''
    ...
    print("✅ Created interface.py")
else:
    print("✅ interface.py already exists")
...
print("   cd str(PROJECT_ROOT / "concept_mesh")
print("   pip install -e .")
