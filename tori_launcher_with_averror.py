#!/usr/bin/env python3
"""
TORI Launcher with Complete AV Fix including AVError
"""
...
print("Applying complete AV compatibility fix with AVError...")
...
# AVError exception (required by torchvision)
...
print("AV compatibility fix with AVError applied successfully!")
...
try:
    ...
    try:
        ...
        if hasattr(isolated_startup, 'main'):
            isolated_startup.main()
        else:
            # If no main function, just import worked
            print("Isolated startup loaded successfully")
