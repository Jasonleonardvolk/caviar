        ...
        case 'transcode':
            try {
                ...
                for (let level = 0; level < levelCount; level++) {
                    ...
                    // Transcode the image
                    const success = ktx2.transcodeImage(data, 0, // imageIndex
                    level, // levelIndex
                    transcoderFormat, 0, // getAlphaForOpaqueFormats
                ...
                self.postMessage(response, levels.map(l => l.data));
            }
            catch (error) {
                const response = {
                    id: msg.id,
