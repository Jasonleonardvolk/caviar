...
declare module '$env/static/private' {
	...
	export const ENABLE_PENROSE: string;
	...
	export const SOLITON_API_URL: string;
	export const SystemDrive: string;
	export const SystemRoot: string;
	export const TEMP: string;
	export const TMP: string;
	export const TOKENIZERS_PARALLELISM: string;
	export const TORI_DISABLE_MESH_CHECK: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		SOLITON_API_URL: string;
		SystemDrive: string;
		SystemRoot: string;
		TEMP: string;
		TMP: string;
		TOKENIZERS_PARALLELISM: string;
		TORI_DISABLE_MESH_CHECK: string;
		USERDOMAIN: string;
