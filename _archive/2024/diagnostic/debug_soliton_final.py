...
print("\n=== SUMMARY ===")
print("If routes are not mounting, check:")
print("1. SOLITON_AVAILABLE flag in api/routes/soliton.py")
print("2. Import errors for mcp_metacognitive.core.soliton_memory")
print("3. Startup logs when running the API")
