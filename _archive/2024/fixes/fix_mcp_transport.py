...
print("🔧 Fixing MCP Server Transport Configuration")
print("=" * 50)

# 1. Update the .env file in mcp_metacognitive directory
env_path = Path(r"{PROJECT_ROOT}\mcp_metacognitive\.env")
print(f"\n✅ Already created .env file at: {env_path}")
...
print("   cd str(PROJECT_ROOT / "mcp_metacognitive")
...
print("\n🚀 Then run: python enhanced_launcher.py")
