...
"""
Fix both issues:
1. Verify concept_mesh_rs is actually installed
2. Fix the indentation error in server.py
"""
...
print("\n1️⃣ Checking concept_mesh_rs installation...")
print("-" * 40)
...
if test.returncode == 0:
    ...
    print(f"❌ Import fails: {test.stderr}")

# Issue 2: Fix server.py indentation
print("\n2️⃣ Fixing server.py indentation...")
print("-" * 40)
...
if backup_path.exists():
    ...
    print("✅ Restored original server.py")
else:
...
if 'mcp.run(transport="sse", host=config.server_host, port=config.server_port)' in content:
    ...
    print("✅ Applied simple fix to server.py")
...
if compile_test.returncode == 0:
    print("✅ server.py has valid syntax")
else:
