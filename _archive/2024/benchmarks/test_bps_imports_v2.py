...
try:
    ...
    success = lattice.create_bps_soliton(0, charge=1.0)
    print(f"   Created BPS soliton: {success}")
...
print("\nNext steps:")
print("1. Run: poetry run python integrate_bps_step1.py")
print("2. Then: poetry run python enhanced_launcher.py --enable-bps --api full")
