...
def generate_audio(text: str, output_path: str):
    ...
    waveform = audio.squeeze().cpu()
    torchaudio.save(output_path, waveform.unsqueeze(0), sample_rate=16000)
    print(f"✅ Audio saved to {output_path}")

if __name__ == "__main__":
    generate_audio("ENOLA reporting. Let's investigate this.", "output/enola.wav")


### FILE: ingest_bus/audio/align_visemes.py
